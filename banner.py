...
def banner_status(colored_status, season_num):
    """to make a nice pretty banner for us, which loads at the top of the game menu"""
    os.system("clear")
    print(f"Season {season_num}")
    if colored_status == "i":
        print(
            colored("Intro >>> ", "green"),
            colored("Pre_season >>> ", "red"),
            colored("Regular Season >>> ", "red"),
            colored("Play-Off >>> ", "red"),
            colored("Season Wind down >>> ", "red"),
            colored("Draft >>> ", "red"),
            colored("Free_Agency", "red"),
        )
    elif colored_status == "ps":
        print(
            colored("Intro >>> ", "red"),
            colored("Pre_season >>> ", "green"),
            colored("Regular Season >>> ", "red"),
            colored("Play-Off >>> ", "red"),
            colored("Season Wind down >>> ", "red"),
            colored("Draft >>> ", "red"),
        ...
        print(
            ...
            colored("Regular Season >>> ", "red"),
            colored("Play-Off >>> ", "red"),
            colored("Season Wind down >>> ", "green"),
            colored("Draft >>> ", "red"),
            colored("Free_Agency", "red"),
        )
