...
def main_run(team_stats_chosen_in, season_num_in):
    ...
    for i in opposition_teams:
        ...
        # shots on target us
        difference_our_att_opp_gk = (
            (our_ata - opposition_gk) + difference_fitness + difference_special_score
        ) / 3
        ...
        # shots on target opp
        difference_opp_att_our_gk = (
            (opposition_att - our_gk) + difference_fitness + difference_special_score
        ) / 3
